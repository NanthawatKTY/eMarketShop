 ...
 <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">จัดการ Seller</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo base_url($lang.'/'); ?>">Home</a>
                                </li>
                                <li class="breadcrumb-item active">จัดการ Seller
                                </li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            <table id="" class="table" style="width: 100%;">
                                                <thead class="border-bottom border-dark">
                                                    <tr>
                                                        <th width="30">No.</th>
                                                        <!-- <th>
                                                            <span class="align-middle">ชื่อร้าน</span>
                                                        </th> -->
                                                        <!-- <th>เบอรโทรศัพท์</th> -->
                                                        <th>อีเมล</th>
                                                        <th>providerId</th>
                                                        ...
                                                        <th width="80">เข้าสู่ระบบครั้งล่าสุด</th>
                                                        <th>Disable</th>
                                                    </tr>
                                                </thead>
                                                <tbody id="admin_seller_tb">
    ...
    <?php $this->load->view('helper/admin/firebase_admin_seller'); ?>