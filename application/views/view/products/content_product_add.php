        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0"><?php echo lang('product_add_new'); ?></h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><?php echo lang('product_add_new'); ?>
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="add_productname" class="form-control"  data-validation-required-message="This field is required" placeholder="<?php echo lang('product_name'); ?>" name="add_productname">
                                                    </div> 
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"><?php echo lang('product_code'); ?></label> <!--required-->
                                                        <input type="text" id="add_productCode" class="form-control"  data-validation-required-message="This field is required" placeholder="<?php echo lang('product_code'); ?>" name="add_productCode">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="projectinput2"><?php echo lang('product_detail'); ?></label>
                                                        <textarea id="add_product_dec" rows="5" class="form-control" name="add_product_dec" placeholder="<?php echo lang('product_detail'); ?>"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="add_productBrand" class="form-control" placeholder="<?php echo lang('product_brand'); ?>" name="add_productBrand">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <fieldset class="form-group">
                                                        <label for="product_add_type"><?php echo lang('product_add_type'); ?></label>
                                                        <select class="form-control" id="product_add_type" name="product_add_type">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <fieldset class="form-group">
                                                        <label for="product_add_type"><?php echo lang('product_add_Shelflife'); ?></label>
                                                        <select class="form-control" id="product_add_Shelflife" name="product_add_Shelflife">
                                                            <option>Select Option</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="product_add_fda"><?php echo lang('product_add_fda'); ?>&nbsp;<a href="#"  data-toggle="modal" data-target="#modal_FDA"><i class="feather icon-alert-circle warning"></i></a></label>
                                                        <input type="text" id="product_add_fda" class="form-control"  placeholder="<?php echo lang('product_add_fda'); ?>" name="product_add_fda">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>         
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="add_productPrice"><?php echo lang('price'); ?></label>
                                                                <div class="position-relative has-icon-left">
                                                                    <input type="number" id="add_productPrice" class="form-control" placeholder="<?php echo lang('price'); ?>" name="add_productPrice">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="add_product_unit">หน่วย</label>
                                                                <select id="add_product_unit" class="form-control unit_product_list" placeholder="หน่วย" name="add_product_unit">
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="add_product_special_Price"><?php echo lang('special_price'); ?></label>
                                                        <div class="position-relative has-icon-left">
                                                            <input type="number" id="add_product_special_Price" class="form-control" placeholder="<?php echo lang('special_price'); ?>" name="add_product_special_Price">
                                                            <div class="form-control-position">
                                                                <span>฿</span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="add_product_minPurchase"><?php echo lang('minPurchase'); ?></label>
                                                        <div class="position-relative has-icon-left">
                                                            <input type="number" id="add_product_minPurchase" class="form-control" placeholder="<?php echo lang('minPurchase'); ?>" name="add_product_minPurchase">
                                                            <div class="form-control-position">
                                                                <span>฿</span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="add_productInventory"><?php echo lang('stock'); ?></label>
                                                        <input type="number" id="add_productInventory" class="form-control" placeholder="<?php echo lang('stock'); ?>" name="add_productInventory">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <p id="price_fee_percent" style="display:none;"></p>
                                                    <i>ค่า Commission <span id="price_fee">0</span>%</i><br>
                                            ...
                                            <div class="row" style="padding-top:20px;">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="checkbox" id="isVariation" class="switchery" data-size="sm"/>
                                                    <div class="form-group displayNone" id="product_selection">
                                                        <div class="form-group">
                                                            <label for="add_productSelectionName"><?php echo lang('name'); ?></label>
                                                            <input type="text" id="add_productSelectionName" class="form-control" placeholder="<?php echo lang('name'); ?>" name="add_productSelectionName">
                                                        </div>
                                                            ...
                                                            <div data-repeater-list="selection">
                                                                <div data-repeater-item>
                                                                    <div class="row">
                                                                        <div class="col-md-5">
                                                                            <div class="form-group">  
                                                                                <input type="text" class="form-control add_productOption" placeholder="<?php echo lang('options'); ?>" name="add_productOption">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div id="image-holder-banner">
                                                    <img src="" class ="thumb-image" width = "437" height="200">
                                                    <i id="delImage0" class="feather icon-trash-2" style="font-size:18px; position: absolute;background: red;padding: 3px;color: white;"></i>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 col-sm-6">
                                                        <input type="file" name="inputAddImage1" id="inputAddImage1" class="input-image checkFileSize" accept="image/x-png,image/gif,image/jpeg">
                                                        ...
                                                        <div id="image-holder1">
                                                            <img src="" class ="thumb-image" width = "140" height="140">
                                                            <i id="delImage1" class="feather icon-trash-2" style="font-size:18px; position: absolute;background: red;padding: 3px;color: white;"></i>
                                                        </div>
                                                        <div class="image-add" id="addImage1"><span class="feather icon-image vertical-center"></span></div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-6">
                                                        <input type="file" name="inputAddImage2" id="inputAddImage2" class="input-image checkFileSize" accept="image/x-png,image/gif,image/jpeg">
                                                        ...
                                                        <div id="image-holder2">
                                                            <img src="" class ="thumb-image" width = "140" height="140">
                                                            <i id="delImage2" class="feather icon-trash-2" style="font-size:18px; position: absolute;background: red;padding: 3px;color: white;"></i>
                                                        </div>
                                                        <div class="image-add" id="addImage2"><span class="feather icon-image vertical-center"></span></div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-6">
                                                        <input type="file" name="inputAddImage3" id="inputAddImage3" class="input-image checkFileSize" accept="image/x-png,image/gif,image/jpeg">
                                                        ...
                                                        <div id="image-holder3">
                                                            <img src="" class ="thumb-image" width = "140" height="140">
                                                            <i id="delImage3" class="feather icon-trash-2" style="font-size:18px; position: absolute;background: red;padding: 3px;color: white;"></i>
                                                        </div>
                                                        <div class="image-add" id="addImage3"><span class="feather icon-image vertical-center"></span></div>
                                                    </div>
                                                    <!-- <div class="col-md-4 col-sm-6">
                                                        <input type="file" name="inputAddImage" id="inputAddImage4" class="input-image" accept="image/x-png,image/gif,image/jpeg">
                                                ...
                                                <div class="row" style="margin-top:12px;">
                                                    <div class="col-md-4 col-sm-6">
                                                        <input type="file" name="inputAddImage4" id="inputAddImage4" class="input-image checkFileSize" accept="image/x-png,image/gif,image/jpeg">
                                                    ...
                                                    <div class="col-md-4 col-sm-6">
                                                        <input type="file" name="inputAddImage5" id="inputAddImage5" class="input-image checkFileSize" accept="image/x-png,image/gif,image/jpeg">
                                                        ...
                                                        <div id="image-holder5">
                                                            <img src="" class ="thumb-image" width = "140" height="140">
                                                            <i id="delImage5" class="feather icon-trash-2" style="font-size:18px; position: absolute;background: red;padding: 3px;color: white;"></i>
                                                        </div>
                                                        <div class="image-add" id="addImage5"><span class="feather icon-image vertical-center"></span></div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-6">
                                                        <input type="file" name="inputAddImage6" id="inputAddImage6" class="input-image checkFileSize" accept="image/x-png,image/gif,image/jpeg">
                                                        ...
                                                        <div id="image-holder6">
                                                            <img src="" class ="thumb-image" width = "140" height="140">
                                                            <i id="delImage6" class="feather icon-trash-2" style="font-size:18px; position: absolute;background: red;padding: 3px;color: white;"></i>
                                                        </div>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">                                                       
                                                        <div class="col-md-4">
                                                            <div class="position-relative has-icon-right">
                                                                <input type="text" id="shipping_w" class="form-control" placeholder="<?php echo lang('w'); ?>" name="shipping_w">
                                                                <div class="form-control-position">
                                                                    cm
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="position-relative has-icon-right">
                                                                <input type="text" id="shipping_l" class="form-control" placeholder="<?php echo lang('l'); ?>" name="shipping_l">
                                                                <div class="form-control-position">
                                                                    cm
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="position-relative has-icon-right">
                                                                <input type="text" id="shipping_h" class="form-control" placeholder="<?php echo lang('h'); ?>" name="shipping_h">
                                                                <div class="form-control-position">
                                                                    cm
                                                                </div>
                                                            </div>
