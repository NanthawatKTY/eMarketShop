								<!-- Completed -->
								<div class="tab-pane" id="completed" aria-labelledby="completed-tab" role="tabpanel" style="display:block">
											...
											<div class="col-12 col-lg-6">
												...
												<div class="form-group floating-label-form-group" style="float: right;">
													...
													<div class='input-group form-group' >
														...
														<!-- Date picker -->
														<button type="button" class="btn btn-outline-success mr-1 mb-1 btn-md"  onclick="exportTableToExcel('tbSuccessExport')"
											...
											<div class="col-12">
												...
												<div class="table-responsive">
													<table class="table  table-bordered mt-1 text-center">
														...
														<tbody class="tbBodySuccess">
														</tbody>
													</table>
													<table id="tbSuccessExport" class="table  table-bordered mt-1 text-center" style="display: none;">
														<thead>
															<tr>
																<th><?php echo lang('all_products'); ?></th>
																<th><?php echo lang('all_orders_price'); ?></th>
														...
														<tbody  class="tbBodySuccessExport">
														</tbody>
													</table>
												</div>
											</div>
									...
									<!-- Order - Completed form ends -->
								</div>
                               <?php $this->load->view('helper/orders/firebase_orders_success') ?>
