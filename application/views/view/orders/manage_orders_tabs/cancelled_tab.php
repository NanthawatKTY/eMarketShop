								<!-- Cancelled -->
								<div class="tab-pane" id="cancelled" aria-labelledby="cancelled-tab" role="tabpanel" style="display:block">
												...
												<div class="form-group floating-label-form-group" style="float: right;">
													<label><?php echo lang('order_date'); ?></label>
														<div class='input-group form-group' >
															...
															<!-- Date picker -->
															<button type="button" class="btn btn-outline-success mr-1 mb-1 btn-md"  onclick="exportTableToExcel('tbCancelExport')"
											...
											<div class="col-12">
												...
												<div class="table-responsive">
													<table class="table  table-bordered mt-1 text-center">
														...
														<tbody class="tbBodyCancel">
														</tbody>
													</table>
													<table id="tbCancelExport" class="table  table-bordered mt-1 text-center" style="display: none;">
														<thead>
															<tr>
																<th><?php echo lang('all_products'); ?></th>
																<th><?php echo lang('all_orders_price'); ?></th>
														...
														<tbody  class="tbBodyCancelExport">
														</tbody>
													</table>
												</div>
											</div>
									...
									<!-- Order - Cancel form ends -->
								</div>
                                <?php $this->load->view('helper/orders/firebase_orders_cancelling') ?>
