<!-- BEGIN: Header-->
    <nav class="header-navbar navbar-expand-md navbar navbar-with-menu fixed-top navbar-semi-light bg-gradient-x-grey-white">
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="<?php echo base_url($lang.'/'); ?>"><img class="brand-logo" alt="stack admin logo" width="32" src="<?php echo base_url('app-assets/img/logo-png.png'); ?>">
                           <h4 class="brand-text" id="title-menu"><?php echo lang('menu_home'); ?></h4>
                        </a></li>
                ...
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        <li class="dropdown dropdown-language nav-item">
                            <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-<?php echo ($lang=='en') ? 'us':'th'; ?>"></i><span class="selected-language"></span></a>
                            <div class="dropdown-menu" aria-labelledby="dropdown-flag"><a class="dropdown-item" href="<?php echo base_url('en/'); ?>" data-language="en"><i class="flag-icon flag-icon-us"></i> English</a><a class="dropdown-item" href="#" data-language="pt"><a class="dropdown-item" href="<?php echo base_url('th/'); ?>" data-language="th"><i class="flag-icon flag-icon-th"></i> ไทย</a></div>
                        </li>
                                ...
                                <li class="scrollable-container media-list"><a href="javascript:void(0)">
                                        <div class="media">
                                            <div class="media-left">
                                                <div class="avatar avatar-online avatar-sm rounded-circle"><img src="<?php echo base_url("app-assets/img/user-default.png"); ?>" alt="avatar"><i></i></div>
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="<?php echo base_url("app-assets/img/user-default.png"); ?>" alt="avatar"><i></i></span></div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="<?php echo base_url("app-assets/img/user-default.png"); ?>" alt="avatar"><i></i></span></div>
                                            <div class="media-body">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="avatar avatar-online"><img src="<?php echo base_url("app-assets/img/user-default.png"); ?>" alt="avatar"><i></i></div><span class="user-name" id="userNameDisplay">John Doe</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#<?php //echo base_url($lang."/profile"); ?>"><i class="feather icon-user"></i> <?php echo lang('editProfile'); ?></a><a class="dropdown-item" href="#"><i class="feather icon-mail"></i> <?php echo lang('myInbox'); ?></a>
                                <div class="dropdown-divider"></div><a class="dropdown-item" href="#" onclick="logout()"><i class="feather icon-power"></i>  <?php echo lang('logout'); ?></a>
                            </div>
                        </li>
                    </ul>
                </div>
